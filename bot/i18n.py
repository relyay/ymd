...
TRANSLATIONS = {
    "ru": {
        ...
        "status_user_header": "Пользователь {target_id}",
        ...
        "admin_love": "<3",
        "addsub_usage": "Использование: /addsub USER_ID DAYS",
        "addsub_invalid": "USER_ID и DAYS должны быть числами.",
        "addsub_done": "Подписка ({display}) выдана пользователю {target_id}",
        "delsub_usage": "Использование: /delsub USER_ID",
        "delsub_invalid": "USER_ID должен быть числом.",
        "delsub_done": "Подписка пользователя {target_id} удалена",
        "ban_usage": "Использование: /ban USER_ID",
        "ban_invalid": "USER_ID должен быть числом.",
        "ban_done": "Пользователь {target_id} забанен",
        "ban_self": "Нельзя забанить самого себя",
        "banned_message": "Вы забанены в этом боте",
    ...
    "en": {
        ...
        "status_user_header": "User {target_id}",
        ...
        "admin_love": "<3",
        "addsub_usage": "Usage: /addsub USER_ID DAYS",
        "addsub_invalid": "USER_ID and DAYS must be numbers.",
        "addsub_done": "Subscription ({display}) granted to user {target_id}",
        "delsub_usage": "Usage: /delsub USER_ID",
        "delsub_invalid": "USER_ID must be a number.",
        "delsub_done": "Subscription removed for user {target_id}",
        "ban_usage": "Usage: /ban USER_ID",
        "ban_invalid": "USER_ID must be a number.",
        "ban_done": "User {target_id} has been banned",
        "ban_self": "You cannot ban yourself",
        "banned_message": "You are banned from this bot",
